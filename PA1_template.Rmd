...
ggplot(activity, aes(x=interval, y=steps)) + stat_summary(fun.y="mean", geom="line") + labs(x = "Interval (hhmm)", y="Average Steps", title="Average Daily Steps Per Interval") + theme_gray()
